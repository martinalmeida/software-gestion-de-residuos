      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" action="php/insertar_cliente.php" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Formulario de Registro de Clientes</b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del cliente" class="form-control in-put" required>
                  </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="telefono" placeholder="Teléfono" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="direccion_admin" placeholder="Dirección administrativa" class="form-control in-put" required>
                  </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class=" col-sm-12 col-md-6">
                    ...
                    <input type="text" name="cotizacion" placeholder="Ref. cotización" class="form-control in-put">
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class=" col-sm-12 col-md-6">
                    ...
                    <input type="text" name="contacto_gen" placeholder="Contacto compras" class="form-control in-put" required>
                  </div>

                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Correo contacto general <span class="rojo">*</span></label>
                    <input type="email" name="correo_gen" placeholder="Correo compras" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="contacto_com" placeholder="Contacto comercial" class="form-control in-put">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Correo contacto comercial </label>
                    <input type="email" name="correo_com" placeholder="Correo comercial" class="form-control in-put">
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-12">
                    ...
                    <textarea class="form-control in-put" name="observaciones"></textarea>
                  </div>
                </div>
               
                <input type="hidden" name="usuarios_id" value="<?php echo $_SESSION["id_user"];  ?>">

...
<?php
    ...
    $query="SELECT * FROM esp_adicionales WHERE id=".$_GET['id'];
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!---------------------------------------------------------------------------------------- 
              Inicio del contenido de la Página CONTAINER-FLUID 
        ------------------------------------------------------------------------------------------>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="register_esp_adicionales" action="php/insertar_esp_adicionales.php" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Consultar Especificaciones adicionales: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del servicio adicional" class="form-control in-put" value="<?php echo $registro['nombre']; ?>"required disabled>
                  </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    <button type="button" onClick="location.href='esp_adicionales.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>
        ...
        <!---------------------------------------------------------------------------------------- 
              FIN del contenido de la Página CONTAINER-FLUID 
        ------------------------------------------------------------------------------------------>

              ...
              <form class="formulario-empresa" id="insertar_residuos" action="php/insertar_residuos_generales.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del residuo" class="form-control in-put">
                  </div>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="number" name="codigo" placeholder="Codigo interno" class="form-control in-put">
                  </div>
                </div>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-4">
                    ...
                    <div class="globo">
                      <input type="text" name="valor" placeholder="" class="form-control in-put" required>

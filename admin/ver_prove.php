      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" action="php/update_prove.php" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Consultar proveedor: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del proveedor / destino" class="form-control in-put" required disabled value="<?php echo $registro['nombre']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Estado <span class="rojo">*</span></label>
                    <select class="custom-select in-put" name="estado" required disabled>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-5">
                    ...
                    <select class="custom-select in-put" name="tipo_ident" required disabled>
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="number" name="identificacion" placeholder="Identificación del cliente" class="form-control in-put" required value="<?php echo $registro['identificacion']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Digito de verificación <span class="rojo">*</span></label>
                    <input type="number" name="digito" placeholder="" class="form-control in-put" required value="<?php echo $registro['digito']; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="representante" placeholder="Representante legal" class="form-control in-put" value="<?php echo $registro['representante']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Teléfono <span class="rojo">*</span></label>
                    <input type="number" name="telefono" placeholder="Teléfono" class="form-control in-put" required value="<?php echo $registro['telefono']; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="direccion_admon" placeholder="Dirección administrativa" class="form-control in-put" required value="<?php echo $registro['direccion_admon']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Dirección correspondencia<span class="rojo">*</span></label>
                    <input type="text" name="direccion_corres" placeholder="Dirección correspondencia" class="form-control in-put" required value="<?php echo $registro['direccion_corres']; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <select class="custom-select in-put" name="pais" required disabled>
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <select class="custom-select in-put" name="ciudad" required disabled>
                ...
                <div class="form-row mt-4">
                  <div class=" col-sm-12 col-md-6">
                    ...
                    <input type="text" name="acti_eco" placeholder="Actividad económica" class="form-control in-put" value="<?php echo $registro['acti_eco']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Sitio Web </label>
                    <input type="text" name="sitio_web" placeholder="Sitio Web" class="form-control in-put" value="<?php echo $registro['sitio_web']; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class=" col-sm-12 col-md-6">
                    ...
                    <select multiple class="form-control in-put" name="tipo_prov" id="exampleFormControlSelect2" required="true" disabled>
                      <option value="<?php echo $registro['tipo_prov']; ?>"><?php echo $registro['tipo_prov']; ?></option>
                    </select>
                  </div>

                  <div class=" col-sm-12 col-md-6">
                    <label for="exampleFormControlSelect2">Disposiciones y manejos</label>
                    <select multiple class="form-control in-put" name="disposiciones[]" id="exampleFormControlSelect2" disabled>
                      <option value="<?php echo $registro['disposiciones']; ?>"><?php echo $registro['disposiciones']; ?></option>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12">
                    <label class="color">Descripción del servicio </label>
                    <textarea class="form-control" name="descripcion" value="<?php echo $registro['descripcion']; ?>"><?php echo $registro['descripcion']; ?></textarea>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class=" col-sm-12 col-md-3">
                    ...
                    <input type="time" name="horario_lv" placeholder="" class="form-control in-put" required value="<?php echo $registro['horario_lv']; ?>" disabled>
                  </div>
                  <div class=" col-sm-12 col-md-3">
                    <label class="color">.</label>
                    <input type="time" name="horario_lv1" placeholder="" class="form-control in-put" required value="<?php echo $registro['horario_lv1']; ?>" disabled>
                  </div>

                  <div class=" col-sm-12 col-md-3">
                    <label class="color">Horario Sabados y domingos </label>
                    <input type="time" name="horario_sd" placeholder="" class="form-control in-put" value="<?php echo $registro['horario_sd']; ?>" disabled>
                  </div>

                  <div class=" col-sm-12 col-md-3">
                    <label class="color">.</label>
                    <input type="time" name="horario_sd1" placeholder="" class="form-control in-put" value="<?php echo $registro['horario_sd1']; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class=" col-sm-12 col-md-6">
                    ...
                    <input type="text" name="contacto_compras" placeholder="Contacto compras" class="form-control in-put" value="<?php echo $registro['contacto_compras']; ?>" disabled>
                  </div>

                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Correo contacto de Compras </label>
                    <input type="email" name="correo_compras" placeholder="Correo compras" class="form-control in-put" value="<?php echo $registro['correo_compras']; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="email" name="contacto_comer" placeholder="Contacto comercial" class="form-control in-put" required value="<?php echo $registro['contacto_comer']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Correo contacto comercial <span class="rojo">*</span></label>
                    <input type="email" name="correo_comer" placeholder="Correo comercial" class="form-control in-put" required value="<?php echo $registro['correo_comer']; ?>" disabled>
                  </div>
                </div>

      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="update_servicio" action="" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Editar Linea de servicio: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <div class="globo">
                      <input type="number" name="codigo" placeholder="" class="form-control in-put" value="<?php echo $registro['codigo']; ?>" required>
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <select class="custom-select in-put" name="unidad" required>
                      <option value="<?php echo $registro['unidad']; ?>"><?php echo $registro['unidad']; ?></option>
                      <?php 
                      include '../gerente/conexion_bd.php';
                      $consulta="SELECT nombre FROM ud_negocio WHERE nit=".$_SESSION["empresas_nit"];

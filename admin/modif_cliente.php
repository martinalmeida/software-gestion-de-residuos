...
<!---------------------------------------------------------------------------------------- 
            Seccion de HTML ( Registro de clientes ) 
------------------------------------------------------------------------------------------>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="update_cliente" action="" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Editar al cliente: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del cliente" class="form-control in-put" required value="<?php echo $registro['nombre']; ?>">
                  </div>
                  ...
                  <div class="col-sm-12 col-md-3">
                    ...
                    <select class="custom-select in-put" name="categoria" required>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class="col-sm-12 col-md-3">
                    ...
                    <input type="number" name="digito" placeholder="" class="form-control in-put" value="<?php echo $registro['digito']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="telefono" placeholder="Teléfono" class="form-control in-put" required value="<?php echo $registro['telefono']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="direccion_admin" placeholder="Dirección administrativa" class="form-control in-put" required value="<?php echo $registro['direccion_admin']; ?>">
                  </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class=" col-sm-12 col-md-6">
                    ...
                    <input type="text" name="cotizacion" placeholder="Ref. cotización" class="form-control in-put" value="<?php echo $registro['cotizacion']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <select class="custom-select in-put" name="asesor" required>
                      <option value="<?php echo $registro['asesor']; ?>"><?php echo $registro['asesor']; ?></option>
                      <?php 
                      include '../gerente/conexion_bd.php';
                      $consulta="SELECT nombre FROM usuarios WHERE rol = 2";
                ...
                <div class="form-row mt-3">
                  <div class=" col-sm-12 col-md-6">
                    ...
                    <input type="text" name="contacto_gen" placeholder="Contacto compras" class="form-control in-put" required value="<?php echo $registro['contacto_gen']; ?>">
                  </div>

                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Correo contacto general <span class="rojo">*</span></label>
                    <input type="email" name="correo_gen" placeholder="Correo compras" class="form-control in-put" required value="<?php echo $registro['correo_gen']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="contacto_com" placeholder="Contacto comercial" class="form-control in-put" value="<?php echo $registro['contacto_com']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Correo contacto comercial </label>
                    <input type="email" name="correo_com" placeholder="Correo comercial" class="form-control in-put" value="<?php echo $registro['correo_com']; ?>">
                  </div>
                </div>
      ...
      <script>
        //alerta al iniciar pagina de (modif cliente.php)
        window.onload = function importante()
          {
            Swal.fire({
              type: 'warning',
              title: 'Recuerda',
              html: 'Una vez registrado el cliente se registrará automáticamente una sucursal principal, si desea actualizar o agregar, diríjase a la opción <b>"Sucursales"</b>.',

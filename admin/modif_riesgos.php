...
<?php
    ...
    $query="SELECT * FROM riesgos WHERE id=".$_GET['id'];
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="update_riesgos" action="" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Editar Riesgo: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del riesgo" class="form-control in-put" value="<?php echo $registro['nombre']; ?>" required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Descripción <span class="rojo">*</span></label>
                    <textarea class="form-control in-put" name="descripcion" placeholder="Efectos negativos que produce" value="<?php echo $registro['descripcion']; ?>" required><?php echo $registro['descripcion']; ?></textarea>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    ...
                    <button type="button" onClick="location.href='riesgos.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>

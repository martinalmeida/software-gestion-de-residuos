              ...
              <form class="formulario-empresa" action="" id="actualizar-user" method="POST" enctype="multipart/form-data">
                 ...
                 <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Consultar usuario: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-5">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre y apellidos" class="form-control in-put" required value="<?php echo $registro['nombre']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Identificación <span class="rojo">*</span></label>
                    <input type="number" name="identificacion" placeholder="Cedula" class="form-control in-put" required value="<?php echo $registro['identificacion']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Cargo </label>
                    <input type="text" name="cargo" placeholder="Cargo del usuario" class="form-control in-put" value="<?php echo $registro['cargo']; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <select class="custom-select in-put" name="rol" required disabled>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <select class="custom-select in-put" name="modulo" required disabled>
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <select class="custom-select in-put" name="propio" required disabled>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="telefono" placeholder="Teléfono" class="form-control in-put" value="<?php echo $registro['telefono']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Celular </label>
                    <input type="text" name="celular" placeholder="Celular" class="form-control in-put" value="<?php echo $registro['celular']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Correo <span class="rojo">*</span></label>
                    <input type="email" name="correo" placeholder="Correo" class="form-control in-put" required value="<?php echo $registro['correo']; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="direccion" placeholder="Dirección" class="form-control in-put" value="<?php echo $registro['direccion']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Pais </label>
                    <select class="custom-select in-put" name="pais" disabled>
                  ...
                  <div class="col-sm-12 col-md-5">
                    ...
                    <select class="custom-select in-put" name="ciudad" disabled>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="usuario" placeholder="Nombre de usuario" class="form-control in-put" required value="<?php echo $registro['usuario']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Clave <span class="rojo">*</span></label>
                    <input type="text" name="contrasena" id="password" placeholder="Clave de Acceso" class="form-control in-put" required value="<?php echo $registro['clave']; ?>" disabled>
                  </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="licencia" placeholder="Número de Licencia de tránsito" class="form-control in-put" value="<?php echo $registro['licencia']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Fecha vencimiento de licencia de tránsito </label>
                    <input type="date" name="fechlicencia" placeholder="" class="form-control in-put"value="<?php echo $registro['fecha_venc']; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6"> 
                      ...
                      <div class="custom-file">
                        <input onchange="ValidateSize1(this)" type="file" id="firma" name="firma"  class="custom-file-input" accept="image/x-png,image/jpg,image/jpeg" disabled />                   
                  ...
                  <div class="col-sm-12 col-md-6">
                      <label class="color">Parafiscales </label>
                       <div class="custom-file">                                   
                        <input onchange="ValidateSize2(this)" type="file" id="parafiscales" name="parafiscales"  class="custom-file-input" accept=".pdf" disabled />                    

...
<?php
    ...
    $query="SELECT * FROM usuarios WHERE id_user=".$_GET['id_user'];
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" action="" id="actualizar-user" method="POST" enctype="multipart/form-data">

                 <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Editar al usuario: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-5">
                    <label class="color">Nombre y apellidos <span class="rojo">*</span></label>
                    <input type="text" name="nombre" placeholder="Nombre y apellidos" class="form-control in-put" required value="<?php echo $registro['nombre']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Identificación <span class="rojo">*</span></label>
                    <input type="number" name="identificacion" placeholder="Cedula" class="form-control in-put" required value="<?php echo $registro['identificacion']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Cargo </label>
                    <input type="text" name="cargo" placeholder="Cargo del usuario" class="form-control in-put" value="<?php echo $registro['cargo']; ?>">
                  </div>
                </div>

                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Rol <span class="rojo">*</span></label>
                    <select class="custom-select in-put" name="rol" required>
                      <option value="<?php echo $registro['rol']; ?>"><?php if($registro['rol']==1){ //gerencial
                                                                            echo "Gerencial";
                                                                            }else
                                                                            if($registro['rol']==2){ //admin
                                                                            echo "Administrador";
                                                                            }else
                                                                            if($registro['rol']==3){ //cliente
                                                                            echo "Cliente";
                                                                            }  ?></option>
                      <?php 
                      include '../gerente/conexion_bd.php';
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Módulo de acceso <span class="rojo">*</span></label>
                    <select class="custom-select in-put" name="modulo" required>
                      <option value="<?php echo $registro['modulo']; ?>"><?php echo $registro['modulo']; ?></option>
                  ...
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Cliente | Proveedor | Propio <span class="rojo">*</span></label>
                    <select class="custom-select in-put" name="propio" required>
                      <option value="<?php echo $registro['propio']; ?>"><?php echo $registro['propio']; ?></option>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="telefono" placeholder="Teléfono" class="form-control in-put" value="<?php echo $registro['telefono']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Celular </label>
                    <input type="text" name="celular" placeholder="Celular" class="form-control in-put" value="<?php echo $registro['celular']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Correo <span class="rojo">*</span></label>
                    <input type="email" name="correo" placeholder="Correo" class="form-control in-put" required value="<?php echo $registro['correo']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class="col-sm-12 col-md-4">
                    <label class="color">Dirección </label>
                    <input type="text" name="direccion" placeholder="Dirección" class="form-control in-put" value="<?php echo $registro['direccion']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Pais </label>
                    <select class="custom-select in-put" name="pais">
                      <option value="<?php echo $registro['pais']; ?>"><?php echo $registro['pais']; ?></option>
                    </select>
                  </div>

                  <div class="col-sm-12 col-md-5">
                    <label class="color">Ciudad / Depto </label>
                    <select class="custom-select in-put" name="ciudad">
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-4">
                    <label class="color">Usuario <span class="rojo">*</span></label>
                    <input type="text" name="usuario" placeholder="Nombre de usuario" class="form-control in-put" required value="<?php echo $registro['usuario']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Clave <span class="rojo">*</span></label>
                    <input type="text" name="contrasena" id="password" placeholder="Clave de Acceso" class="form-control in-put" required value="<?php echo $registro['clave']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-5">
                    <label class="color">Generar Clave </label><br>
                    <button type="button" onclick="getPassword();" class="genclave"><i class="fas fa-sync-alt"></i></button>
                  </div>
                </div>
                ...
                <div class="form-row mt-5">
                  ...
                  <div class="col-sm-12 col-md-7 mt-2">
                    <label>Desea comunicarle al usuario mediante correo electrónico sus credenciales?</label>
                  </div>
                  <div class="col-sm-12 col-md-4">
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Licencia de tránsito </label>
                    <input type="text" name="licencia" placeholder="Número de Licencia de tránsito" class="form-control in-put" value="<?php echo $registro['licencia']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Fecha vencimiento de licencia de tránsito </label>
                    <input type="date" name="fechlicencia" placeholder="" class="form-control in-put"value="<?php echo $registro['fecha_venc']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6"> 
                      ...
                      <div class="custom-file">
                        <input onchange="ValidateSize1(this)" type="file" id="firma" name="firma"  class="custom-file-input" accept="image/x-png,image/jpg,image/jpeg" />                   
                        <label id="lblArchivo" class="custom-file-label imagentxt" for="firma"></label> 
                      </div>
                  </div>

                  <div class="col-sm-12 col-md-6">
                      <label class="color">Parafiscales </label>
                       <div class="custom-file">                                   
                        <input onchange="ValidateSize2(this)" type="file" id="parafiscales" name="parafiscales"  class="custom-file-input" accept=".pdf" />                    
                        <label id="lblArchivo" class="custom-file-label" for="parafiscales"></label> 
                       </div>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6" style="text-align: center;">
                    <hr>
                    <label class="color" style="color: #7bb728">Firma cargada </label>
                    <div>
                      <?php if ($registro['firma']== null) {
                      echo "Ninguna Firma adjunta";
                    }else{
                      echo '<img src="'.$registro['firma'].'" width="100" height="100">';
                    } 
                    ?>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-12 col-md-6" style="text-align: center;">
                    <hr>
                     <label class="color" style="color: #7bb728">Archivo cargado de parafiscales </label>
                     <div>
                      <?php
                      if ($registro['parafiscales']== null) { ?>
                        <p>Ningun Archivo adjunto</p>
                       <?php }else{ ?>
                        <a target="_blank" href="pdf_usuarios.php?id_user=<?php echo $registro['id_user'];?>"><button class="btn btn-success btnpdf" type="button"><i class="far fa-file-pdf"></i></button></a>
                        <?php } ?>
                     </div>
                  </div>
                ...
                <input type="hidden" name="usuarios_id" value="<?php echo $registro['id_user']; ?>">
                <input type="hidden" name="nit" value="<?php echo $_SESSION["empresas_nit"];  ?>">
                <div class="form-row mt-5">
                  <div class="col-sm-12 col-md-12 text-center">
                    <button type="submit" class="botonreg">Guardar</button>
                    <button type="button" onClick="location.href='usuarios.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>
      ...
      <?php require_once "vistas/vista_inferior.php"?>
          ...
          <!-- Estilo generador de contraseñas -->
          <script>
          ...
          <!-- Estilos selección de archivo IMAGEN-->
        ...
        <script type="text/javascript">
          ...
          $("#firma").on('change', function() {
              ...
              $(this).siblings(".imagentxt").addClass("selected").html(fileName);        
          })
        ...
        <!-- Estilos selección de archivo de parafiscales -->
        <script type="text/javascript">
          $(document).ready(function() {

          $("#parafiscales").on('change', function() {
              var fileName = $(this).val().split("\\").pop();
        ...
        <script>
            ...
            var FileSize = file.files[0].size / 1024 / 1024; // in MB
            if (FileSize > 3) {
              input=document.getElementById("parafiscales");
              input.value = '' 
                Swal.fire({
                  type:'error',
                  title:'Excede los 3MB permitidos',
                ...
                if (!allowedExtensions.exec(fileName)) {
                  ...
                  Swal.fire({
                  type:'error',
                  title:'Solo se permite los parafiscales en (PDF)',
                  confirmButtonColor:'#76a03f',
                  confirmButtonText:'Ok'
              }).then((result) => {
                  if(result.value){

...
?>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="update_proveedores" action="" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Editar al proveedor: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Razón social / Nombre <span class="rojo">*</span></label>
                    <input type="text" name="nombre" placeholder="Nombre del proveedor / destino" class="form-control in-put" required value="<?php echo $registro['nombre']; ?>">
                  </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-5">
                    <label class="color">Tipo de identificación <span class="rojo">*</span></label>
                    <select class="custom-select in-put" name="tipo_ident" required>
                      <option value="<?php echo $registro['tipo_ident']; ?>"><?php echo $registro['tipo_ident']; ?></option>
                  ...
                  <div class="col-sm-12 col-md-4">
                    <label class="color">NIT / Cédula <span class="rojo">*</span></label>
                    <input type="number" name="identificacion" placeholder="Identificación del cliente" class="form-control in-put" required value="<?php echo $registro['identificacion']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Digito de verificación <span class="rojo">*</span></label>
                    <input type="number" name="digito" placeholder="" class="form-control in-put" required value="<?php echo $registro['digito']; ?>">
                  </div>
                </div>

                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Representante legal </label>
                    <input type="text" name="representante" placeholder="Representante legal" class="form-control in-put" value="<?php echo $registro['representante']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Teléfono <span class="rojo">*</span></label>
                    <input type="number" name="telefono" placeholder="Teléfono" class="form-control in-put" required value="<?php echo $registro['telefono']; ?>">
                  </div>
                </div>

                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Dirección administrativa<span class="rojo">*</span></label>
                    <input type="text" name="direccion_admon" placeholder="Dirección administrativa" class="form-control in-put" required value="<?php echo $registro['direccion_admon']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Dirección correspondencia<span class="rojo">*</span></label>
                    <input type="text" name="direccion_corres" placeholder="Dirección correspondencia" class="form-control in-put" required value="<?php echo $registro['direccion_corres']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Actividad económica </label>
                    <input type="text" name="acti_eco" placeholder="Actividad económica" class="form-control in-put" value="<?php echo $registro['acti_eco']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Sitio Web </label>
                    <input type="text" name="sitio_web" placeholder="Sitio Web" class="form-control in-put" value="<?php echo $registro['sitio_web']; ?>">
                  </div>
                </div>

                <div class="form-row mt-4">
                  <div class=" col-sm-12 col-md-6">
                    <label for="exampleFormControlSelect2">Tipo de proveedor/destino <span class="rojo">*</span></label>
                    <select multiple class="form-control in-put" name="tipo_prov[]" id="exampleFormControlSelect2" required="true">
                      <option selected value="<?php echo $registro['tipo_prov']; ?>"><?php echo $registro['tipo_prov']; ?></option>
                      <option value="RESPEL">RESPEL</option>
                      <option value="RECICLAJE">RECICLAJE</option>
                      <option value="RESIDUOS ESPECIALES">RESIDUOS ESPECIALES</option>
                      <option value="LOGISTICA">LOGISTICA</option>
                      <option value="ORDINARIOS">ORDINARIOS</option>
                      <option value="POSCONSUMO">POSCONSUMO</option>
                    </select>
                  </div>

                  <div class=" col-sm-12 col-md-6">
                    <label for="exampleFormControlSelect2">Disposiciones y manejos</label>
                    <select multiple class="form-control in-put" name="disposiciones[]" id="exampleFormControlSelect2">
                      <option selected value="<?php echo $registro['disposiciones']; ?>"><?php echo $registro['disposiciones']; ?></option>
                      <?php 
                      include '../gerente/conexion_bd.php';
                      $consulta="SELECT nombre FROM disposicion_manejo WHERE nit=".$_SESSION["empresas_nit"];
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-5">
                      <label class="color">Cargar Archivo Licencia ambiental (PDF) Maximo 3MB </label>
                       <div class="custom-file">                                   
                        <input onchange="ValidateSize2(this)" type="file" id="licencia" name="licencia"  class="custom-file-input" accept=".pdf" />                    
                        <label id="lblArchivo" class="custom-file-label" for="licencia"></label> 
                       </div>
                  </div>

                  <div class="col-sm-12 col-md-5" style="text-align: center;">
                     <label class="color" style="color: #7bb728">Archivo de Licencia Ambiental </label>
                     <div>
                      <?php
                      if ($registro['licencia']== null) { ?>
                        <p>Ningun Archivo adjunto</p>
                       <?php }else{ ?>
                        <a target="_blank" href="php/ver_licencia_pdf_proveedores.php?id=<?php echo $registro['id'];?>"><button class="btn btn-success btnpdf" type="button"><i class="far fa-file-pdf"></i></button></a>
                        <?php } ?>
                     </div>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12">
                    ...
                    <textarea class="form-control" name="descripcion" value="<?php echo $registro['descripcion']; ?>"></textarea>
                  </div>
                </div>

                <div class="form-row mt-4">
                  <div class=" col-sm-12 col-md-3">
                    <label class="color">Horario Lunes a viernes <span class="rojo">*</span></label>
                    <input type="time" name="horario_lv" placeholder="" class="form-control in-put" required value="<?php echo $registro['horario_lv']; ?>">
                  </div>
                  <div class=" col-sm-12 col-md-3">
                    <label class="color">.</label>
                    <input type="time" name="horario_lv1" placeholder="" class="form-control in-put" required value="<?php echo $registro['horario_lv1']; ?>">
                  </div>

                  <div class=" col-sm-12 col-md-3">
                    <label class="color">Horario Sabados y domingos </label>
                    <input type="time" name="horario_sd" placeholder="" class="form-control in-put" value="<?php echo $registro['horario_sd']; ?>">
                  </div>

                  <div class=" col-sm-12 col-md-3">
                    <label class="color">.</label>
                    <input type="time" name="horario_sd1" placeholder="" class="form-control in-put" value="<?php echo $registro['horario_sd1']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Contacto de Compras </label>
                    <input type="text" name="contacto_compras" placeholder="Contacto compras" class="form-control in-put" value="<?php echo $registro['contacto_compras']; ?>">
                  </div>

                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Correo contacto de Compras </label>
                    <input type="email" name="correo_compras" placeholder="Correo compras" class="form-control in-put" value="<?php echo $registro['correo_compras']; ?>">
                  </div>
                </div>

                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Contacto comercial <span class="rojo">*</span></label>
                    <input type="text" name="contacto_comer" placeholder="Contacto comercial" class="form-control in-put" required value="<?php echo $registro['contacto_comer']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Correo contacto comercial <span class="rojo">*</span></label>
                    <input type="email" name="correo_comer" placeholder="Correo comercial" class="form-control in-put" required value="<?php echo $registro['correo_comer']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    ...
                    <button type="button" onClick="location.href='proveedores.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>
      ...
      //alerta al iniciar pagina de (modif_prove.php)
       window.onload = function importante()
          {
            Swal.fire({
              type: 'warning',
              title: 'Recuerda',
              html: 'Una vez registrado el proveedor se registrará automáticamente una sucursal principal, si desea actualizar o agregar, diríjase a la opción <b>"Sucursales"</b>.',
      ...
      function ValidateSize2(file) {
        ...
        if (FileSize > 3) {
          input=document.getElementById("licencia");
          input.value = '' 
            Swal.fire({
              type:'error',
            ...
            if (!allowedExtensions.exec(fileName)) {
              ...
              Swal.fire({
              type:'error',
              title:'Solo se permite la Licencia en (PDF)',
              confirmButtonColor:'#76a03f',
              confirmButtonText:'Ok'
          }).then((result) => {
              if(result.value){

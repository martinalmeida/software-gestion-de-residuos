      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="register_zonas" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="" class="form-control in-put" disabled value="<?php echo $registro['nombre']; ?>" required>
                  </div>

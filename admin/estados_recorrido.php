...
$consulta = "SELECT * FROM estados_recorrido WHERE nit=".$_SESSION["empresas_nit"];
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="estados_recorrido.php"><i class="fas fa-road"></i>   Estados del recorrido</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 animated fadeInUp"><b>Estado del recorrido</b></h1>
            <a href="register_estados_recorrido.php" class="d-none d-sm-inline-block btn btn-sm shadow-sm btnagregar"><i class="fas fa-user-plus text-white"></i> Registrar</a>  
          </div>


          <!-- Tabla de Estados del recorrido-->
          <div class="table-responsive">        
                        <table id="tablaPersonas" class="table table-striped table-bordered table-condensed" style="width:100%">
                        <thead class="text-center">
                          <button class="button_excel" type="button" onClick="location.href='excel/excel_estado.php'" ><i class="far fa-file-excel"></i></button>
                          <a href="pdf/estados.php" target="_blank"><button class="button_pdf" type="button"><i class="far fa-file-pdf"></i></button></a>
                            <tr>
                                ...
                                <th style='white-space: nowrap; width: 1px;color: #000'>Orden</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['orden'] ?></td>
                                <td style='white-space: nowrap; width: 1px; text-align: center;'><?php echo "<a href='ver_estados_recorrido.php?id=".$dat['id']."'><button type='button'class='btn btn-primary colorbtn'><i class='far fa-eye'></i></button></a>"."<a href='modif_estados_recorrido.php?id=".$dat['id']."'><button type='button' class='btn btn-success1'><i class='fas fa-edit'></i></button></a>"."<a href='php/delete_estado_recorrido.php?id=".$dat['id']."' class='borrar2'><button type='button' class='btn btn-danger'><i class='fas fa-trash-alt'></i></button></a>";?></td>

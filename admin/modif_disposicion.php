...
<?php
    ...
    $query="SELECT * FROM disposicion_manejo WHERE id_disposicion=".$_GET['id_disposicion'];
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="update_disposicion_manejo" action="" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Editar Disposición: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre de la disposición final" class="form-control in-put" value="<?php echo $registro['nombre']; ?>" required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Descripción del manejo / disposición <span class="rojo">*</span></label>
                    <textarea class="form-control in-put" name="descripcion" placeholder="Descripción" value="<?php echo $registro['descripcion']; ?>" required=""><?php echo $registro['descripcion']; ?></textarea>
                  </div>
                </div>

                <input type="hidden" name="nit" value="<?php echo $_SESSION["empresas_nit"];  ?>">
                <input type="hidden" name="id_disposicion" value="<?php echo $registro['id_disposicion']; ?>">
                  
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    <button type="submit" class="botonreg">Guardar</button>
                    <button type="button" onClick="location.href='disposicion.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>

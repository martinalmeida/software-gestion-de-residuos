  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!---------------------------------------------------------------------------------------- 
              Inicio del contenido de la Página de REGISTRO  y CONTAINER-FLUID 
        ------------------------------------------------------------------------------------------>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="actualizarnegocio" action="php/actualizar_perfil.php" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Información del negocio</b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Razon social / Nombre </label>
                    <input type="text" name="nombre" placeholder="" class="form-control in-put" value="<?php echo $registro['nombre']; ?>">
                  </div>

                 <div class="col-sm-12 col-md-3">
                    <label class="color">NIT </label>
                    <input type="number" class="form-control in-put" value="<?php echo $registro['nit']; ?>" disabled>
                    <input type="hidden" name="nit" value="<?php echo $registro['nit']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Digito de verificación </label>
                    <input type="number" class="form-control in-put" value="<?php echo $registro['digito']; ?>" disabled>
                    <input type="hidden" name="digito" value="<?php echo $registro['digito']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="representante" placeholder="" class="form-control in-put" value="<?php echo $registro['representante']; ?>">
                  </div>

                 <div class="col-sm-12 col-md-6">
                    <label class="color">Teléfono </label>
                    <input type="number" name="telefono" placeholder="" class="form-control in-put" value="<?php echo $registro['telefono']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="direccion" placeholder="" class="form-control in-put" value="<?php echo $registro['direccion']; ?>">
                  </div>

                 <div class="col-sm-12 col-md-6">
                    <label class="color">Email administración </label>
                    <input type="email" name="correo_admin" placeholder="" class="form-control in-put" value="<?php echo $registro['correo']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <select class="custom-select in-put" name="pais">
                      <option value="<?php echo $registro['pais']; ?>">Colombia</option>
                    </select>
                  </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Contacto </label>
                    <input type="text" name="contacto" placeholder="" class="form-control in-put" value="<?php echo $registro['contacto']; ?>">
                  </div>

                 <div class="col-sm-12 col-md-6">
                    <label class="color">Email técnico </label>
                    <input type="email" name="correro_tecn" placeholder="" class="form-control in-put" value="<?php echo $registro['email_tec']; ?>">
                  </div>
                </div>

                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Email logistica </label>
                    <input type="email" name="correo_logis" placeholder="" class="form-control in-put" value="<?php echo $registro['email_logis']; ?>">
                  </div>

                 <div class="col-sm-12 col-md-6">
                    <label class="color">Sitio web </label>
                    <input type="text" name="sitio_web" placeholder="" class="form-control in-put" value="<?php echo $registro['sitio_web']; ?>">
                  </div>
                </div>

                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-5" style="text-align: center; margin-top: 36px;">
                    <button class="botonlogo" type="button" data-toggle="modal" data-target="#logo-modal"><i class="far fa-images" style="font-size: 15px;"></i>  Cambiar logo</button>
                  </div>

                    <div class="modal fade" id="logo-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="form-row modalp">
                              <label class="color">Logo (PNG, JPG, JPEG) Maximo 3MB</label>
                               <div class="custom-file">                                   
                                  <input onchange="ValidateSize1(this)" type="file" data-target="#logo-negocio" id="logoimg" name="logo_file"  class="custom-file-input" accept="image/x-png,image/jpg,image/jpeg" />                    
                                  <label id="lblArchivo" class="custom-file-label imagentxt" for="logopdf"></label> 
                               </div>
                            </div> 
                               <div class="modal-footer">
                                <button class="btn btn-success firmalis" type="submit" data-dismiss="modal">Listo</button>
                              </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-sm-12 col-md-6 mt-3" style="text-align: center;">
                    <?php if ($registro['logo_file']== null) {
                      echo "Ningún Logo adjunto";
                    }else{
                      echo '<img src="'.$registro['logo_file'].'" width="100" height="100">';
                    } 
                    ?>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12">
                    <label class="color">Licencia Ambiental </label>
                    <textarea class="form-control in-put" name="licenciatxt" value="<?php echo $registro['licencia']; ?>"><?php echo $registro['licencia']; ?></textarea>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-5">
                      <label class="color">Cargar Archivo Licencia ambiental (PDF) Maximo 3MB </label>
                       <div class="custom-file">                                   
                        <input onchange="ValidateSize2(this)" type="file" id="licenciapdf" name="licencia_file"  class="custom-file-input" accept=".pdf" />                    
                        <label id="lblArchivo" class="custom-file-label" for="licenciapdf"></label> 
                       </div>
                  </div>

                  <div class="col-sm-12 col-md-1"></div>
                  <div class="col-sm-12 col-md-6" style="text-align: center;">
                     <label class="color">Licencia ambiental cargada </label>
                     <div>
                      <?php
                      if ($registro['licencia_file']== null) { ?>
                        <p>Ningún Archivo adjunto</p>
                       <?php }else{ ?>
                        <a target="_blank" href="ver_licencia_pdf.php?nit=<?php echo $registro['nit'];?>"><button class="btn btn-success btnpdf" type="button"><i class="far fa-file-pdf"></i></button></a>
                        <?php } ?>
                     </div>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Responsable plan de contingencia </label>
                    <select class="custom-select in-put" name="responsable">
                      <option value="<?php echo $registro['responsable_plan']; ?>"><?php echo $registro['responsable_plan']; ?></option>
                      <?php 
                      include '../gerente/conexion_bd.php';
                      $consulta="SELECT nombre FROM usuarios WHERE rol = 2 AND empresas_nit=".$_SESSION["empresas_nit"];
                 ...
                 <div class="col-sm-12 col-md-6">
                    <label class="color">Contactos en caso de emergencia </label>
                    <input type="text" name="contacto_emer" placeholder="" class="form-control in-put" value="<?php echo $registro['contactos_emerg']; ?>">
                  </div>
                </div>
                  
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    <button type="submit" class="botonreg">Actualizar</button>
                  </div>
                </div>
        ...
        <!---------------------------------------------------------------------------------------- 
              FIN del contenido de la Página de REGISTRO y CONTAINER-FLUID 
        ------------------------------------------------------------------------------------------>
...
//Validación de LOGO
  ...
  if (FileSize > 3) {
    input=document.getElementById("logoimg");
    input.value = '' 
      Swal.fire({
        type:'error',
...
//Selección de LICENCIA AMBIENTAL
 $(document).ready(function() {

$("#licenciapdf").on('change', function() {
    var fileName = $(this).val().split("\\").pop();
...
//Validación de LICENCIA AMBIENTAL
function ValidateSize2(file) {
  var fileName = file.files[0].name;
  var FileSize = file.files[0].size / 1024 / 1024; // in MB
  if (FileSize > 3) {
    input=document.getElementById("licenciapdf");
    input.value = '' 
      Swal.fire({
        type:'error',
        title:'Excede los 3MB permitidos',

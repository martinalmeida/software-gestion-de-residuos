      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="register_sucursal.php" class="d-none d-sm-inline-block btn btn-sm shadow-sm btnagregar"><i class="fas fa-user-plus text-white"></i> Registrar</a>  
          </div>
          ...
          <div class="table-responsive">        
                        ...
                        <thead class="text-center">
                          <button class="button_excel" type="button" onClick="location.href='excel/excel_sucursales.php'" ><i class="far fa-file-excel"></i></button>
                          <a href="pdf/sucursales.php" target="_blank"><button class="button_pdf" type="button"><i class="far fa-file-pdf"></i></button></a> 
                            <tr>
                                <th style='white-space: nowrap; width: 1px;color: #000'>ID</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Tipo</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Origen</th>                    
                                <th style='white-space: nowrap; width: 1px;color: #000'>Nombre</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Clasificación</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Contacto</th>
                                ...
                                <th style='white-space: nowrap; width: 1px;color: #000'>Ciudad / Depto</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Zona</th>
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['id_sucur'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['tipo'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['origen'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['nombre'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['clasificacion'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['contacto'] ?></td>
                                ...
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['zona'] ?></td>
                               ...
                               <?php } ?></td>
                                ...
                                <td style='white-space: nowrap; width: 1px; text-align: center;'><?php echo "<a href='ver_sucursal.php?id_sucur=".$dat['id_sucur']."'><button type='button'class='btn btn-primary colorbtn'><i class='far fa-eye'></i></button></a>"."<a href='modif_sucursal.php?id_sucur=".$dat['id_sucur']."'><button type='button' class='btn btn-success1'><i class='fas fa-edit'></i></button></a>"."<a href='php/delete_sucursal.php?id_sucur=".$dat['id_sucur']."' class='borrar2'><button type='button' class='btn btn-danger'><i class='fas fa-trash-alt'></i></button></a>";?></td>

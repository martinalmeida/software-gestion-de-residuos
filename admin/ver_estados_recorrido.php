...
<?php
    ...
    $query="SELECT * FROM estados_recorrido WHERE id=".$_GET['id'];
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="insertar_estados_recorrido" action="php/insertar_estados_recorrido.php" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Consultar Estados del recorrido: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del estado" class="form-control in-put" value="<?php echo $registro['nombre']; ?>" disabled required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Descripción </label>
                    <textarea class="form-control in-put" name="descripcion" value="<?php echo $registro['descripcion']; ?>" placeholder="Descripción del estado" disabled ><?php echo $registro['descripcion']; ?></textarea>
                  </div>
                </div>

                <div class="form row mt-2">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Orden </label>
                    <div class="globo">
                      <input type="number" name="orden" placeholder="Orden del estado" class="form-control in-put" disabled value="<?php echo $registro['orden']; ?>">
                      <span>Prioridad del estado</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    <button type="button" onClick="location.href='estados_recorrido.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>

              ...
              <form class="formulario-empresa" id="" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Consulta Riesgo: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del riesgo" class="form-control in-put" value="<?php echo $registro['nombre']; ?>" disabled required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Descripción <span class="rojo">*</span></label>
                    <textarea class="form-control in-put" name="descripcion" value="<?php echo $registro['descripcion']; ?>" placeholder="Efectos negativos que produce" required ><?php echo $registro['descripcion']; ?></textarea>
                  </div>
                </div>

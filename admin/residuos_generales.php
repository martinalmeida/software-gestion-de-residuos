      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="register_residuos_generales.php" class="d-none d-sm-inline-block btn btn-sm shadow-sm btnagregar"><i class="fas fa-user-plus text-white"></i> Registrar</a>  
          </div>


          <!-- Tabla de Residuos Generales-->
          <div class="table-responsive">        
                        <table id="tablaPersonas" class="table table-striped table-bordered table-condensed" style="width:100%">
                        <thead class="text-center">
                          <button class="button_excel" type="button" onClick="location.href='excel/excel_residuos.php'" ><i class="far fa-file-excel"></i></button>
                          <a href="pdf/residuos.php" target="_blank"><button class="button_pdf" type="button"><i class="far fa-file-pdf"></i></button></a>
                            <tr>
                                <th style='white-space: nowrap; width: 1px;color: #000'>ID</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Nombre</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Estado Físico</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Descripción</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Disposición y Manejo</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Codigo interno</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Valor unitario</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Métrica</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Tipo de facturación</th>                       
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['id_residuos'] ?></td>
                                ...
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['disposicion'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['codigo'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['valor'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['metrica'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['facturacion'] ?></td>
                                <td style='white-space: nowrap; width: 1px; text-align: center;'><?php echo "<a href='ver_residuos_generales.php?id_residuos=".$dat['id_residuos']."'><button type='button'class='btn btn-primary colorbtn'><i class='far fa-eye'></i></button></a>"."<a href='modif_residuos_generales.php?id_residuos=".$dat['id_residuos']."'><button type='button' class='btn btn-success1'><i class='fas fa-edit'></i></button></a>"."<a href='php/delete_residuos_generales.php?id_residuos=".$dat['id_residuos']."' class='borrar2'><button type='button' class='btn btn-danger'><i class='fas fa-trash-alt'></i></button></a>";?></td>

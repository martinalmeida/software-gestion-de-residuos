...
<?php
    ...
    $query="SELECT * FROM sucursales WHERE id_sucur=".$_GET['id_sucur'];
...
?>
  ...
  <div id="wrapper">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="sucursales.php"><i class="fas fa-map-marked-alt"></i>  Sucursales</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="update_sucursal" action="" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Editar Sucursal: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Tipo <span class="rojo">*</span></label>
                    <select class="custom-select in-put" name="tipo" required>
                      <option value="<?php echo $registro['tipo']; ?>"><?php echo $registro['tipo']; ?></option>
                      <?php if ($registro['tipo'] == "Cliente"){ ?>
                        <option value="Proveedor">Proveedor</option>
                        <option value="Propia">Propia</option>
                      <?php }else if($registro['tipo'] == "Proveedor"){ ?>
                  ...
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Origen <span class="rojo">*</span></label>
                    <select class="custom-select in-put" name="origen" required>
                      <option value="<?php echo $registro['origen']; ?>"><?php echo $registro['origen']; ?></option>
                      <option value="Propia">Propia</option>

                      <option value="" style="color: #217b1c;"><b>Seleccione Clientes</b></option>
                      <?php 
                      include '../gerente/conexion_bd.php';
                      $consulta="SELECT nombre FROM clientes WHERE nit=".$_SESSION["empresas_nit"];
                      ...
                      <option value="" style="color: #217b1c;"><b>Seleccione Proveedores</b></option>

                      <?php 
                      include '../gerente/conexion_bd.php';
                      $consulta="SELECT nombre FROM proveedores WHERE nit=".$_SESSION["empresas_nit"];
                      $ejecutar=mysqli_query($mysqli,$consulta) OR die (mysqli_error($mysqli))
                      ?>
                ...
                <div class="form-row mt-4">
                 ...
                 <div class="col-sm-12 col-md-3">
                    <label class="color">Clasificación </label>
                    <select class="custom-select in-put" name="clasificacion">
                      <option value="<?php echo $registro['clasificacion']; ?>"><?php echo $registro['clasificacion']; ?></option>

                      <?php if ($registro['clasificacion'] == "Residencial"){ ?>
                        <option value="Industrial">Industrial</option>
                        <option value="Institucional">Institucional</option>
                        <option value="Comercial">Comercial</option>
                      <?php }else if($registro['clasificacion'] == "Industrial"){ ?>
                        <option value="Residencial">Residencial</option>
                        <option value="Institucional">Institucional</option>
                        <option value="Comercial">Comercial</option>
                      <?php }else if($registro['clasificacion'] == "Institucional"){ ?>
                        <option value="Residencial">Residencial</option>
                        <option value="Industrial">Industrial</option>
                        <option value="Comercial">Comercial</option>
                      <?php }else{ ?>
                  ...
                  <div class="col-sm-12 col-md-4">
                    <label class="color">Contacto <span class="rojo">*</span></label>
                    <input type="text" name="contacto" placeholder="Nombre del contacto" class="form-control in-put" value="<?php echo $registro['contacto']; ?>" required>
                  </div>
                </div>

                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Telefono <span class="rojo">*</span></label>
                    <input type="number" name="telefono" placeholder="Telefono de la sucursal" class="form-control in-put" value="<?php echo $registro['telefono']; ?>" required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Celular <span class="rojo">*</span></label>
                    <input type="number" name="celular" placeholder="" class="form-control in-put" value="<?php echo $registro['celular']; ?>" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="email" name="correo" placeholder="Correo del contacto" class="form-control in-put" value="<?php echo $registro['correo']; ?>"required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Dirección <span class="rojo">*</span></label>
                    <input type="text" name="direccion" placeholder="Dirección de la sucursal" class="form-control in-put" value="<?php echo $registro['direccion']; ?>" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class="col-sm-12 col-md-4">
                    <label class="color">Zona </label>
                    <select class="custom-select in-put" name="zona">
                      <option value="<?php echo $registro['zona']; ?>"><?php echo $registro['zona']; ?></option>
                      <?php 
                      include '../gerente/conexion_bd.php';
                      $consulta="SELECT nombre FROM zonas WHERE nit=".$_SESSION["empresas_nit"];
                      $ejecutar=mysqli_query($mysqli,$consulta) OR die (mysqli_error($mysqli))
                      ?>
                ...
                <div class="form-row mt-4">
                  <div class=" col-sm-12 col-md-3">
                    ...
                    <input type="time" name="horario_lv" placeholder="" class="form-control in-put" value="<?php echo $registro['horario_lv']; ?>" required>
                  </div>
                  <div class=" col-sm-12 col-md-3">
                    <label class="color">.</label>
                    <input type="time" name="horario_lv1" placeholder="" class="form-control in-put" value="<?php echo $registro['horario_lv1']; ?>" required>
                  </div>
                ...
                <div class="form-row mt-3">
                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Latitud <span class="rojo">*</span></label>
                    <input type="text" name="latitud" id="latitud" placeholder="Contacto compras" class="form-control in-put" value="<?php echo $registro['latitud']; ?>" required>
                  </div>

                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Longitud <span class="rojo">*</span></label>
                    <input type="text" id="longitud" name="longitud" placeholder="Correo compras" class="form-control in-put" value="<?php echo $registro['longitud']; ?>" required>
                  </div>
                </div>

                
                <input type="hidden" name="nit" value="<?php echo $_SESSION["empresas_nit"];  ?>">
                <input type="hidden" name="id_sucur" value="<?php echo $registro['id_sucur']; ?>">
                  

                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    <button type="submit" class="botonreg">Guardar</button>
                    <button type="button" onClick="location.href='sucursales.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>
      ...
      <script>
        //alerta al iniciar pagina de (modif_sucursal.php)
        window.onload = function importante()
          {
            Swal.fire({
              type: 'warning',
              title: 'Recuerda',
              html: 'No olvides llenar cada uno de los campos y <b>registrar clientes</b> y <b>proveedores</b> antes de crear nuevas sucursales.',

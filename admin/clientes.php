      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="register_cliente.php" class="d-none d-sm-inline-block btn btn-sm shadow-sm btnagregar"><i class="fas fa-user-plus text-white"></i> Registrar</a>  
          </div>
          ...
          <div class="table-responsive">        
                        ...
                        <thead class="text-center">
                          <button class="button_excel" type="button" onClick="location.href='excel/excel_clientes.php'" ><i class="far fa-file-excel"></i></button>
                          <a href="pdf/clientes.php" target="_blank"><button class="button_pdf" type="button"><i class="far fa-file-pdf"></i></button></a> 
                            <tr>
                                ...
                                <th style='white-space: nowrap; width: 1px;color: #000'>Categoria</th>  
                                <th style='white-space: nowrap; width: 1px;color: #000'>Tipo de identificación</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Identificacion</th>
                                ...
                                <th style="white-space: nowrap; width: 1px; color: #000">Direccion Administrativa</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Direccion Corresponsal</th>
                                ...
                                <th style='white-space: nowrap; width: 1px;color: #000'>Cotización</th>
                                ...
                                <th style='white-space: nowrap; width: 1px;color: #000'>Asesor</th>                                
                                <th style='white-space: nowrap; width: 1px;color: #000'>Contacto General</th>  
                                <th style="white-space: nowrap; width: 1px; color: #000">Correo General</th>
                                ...
                                <th style='white-space: nowrap; width: 1px;color: #000'>Observaciones</th>                                
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['id_clientes'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['nombre'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['estado'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['categoria'] ?></td>
                                ...
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['direccion_admin'] ?></td>
                                ...
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['cotizacion'] ?></td>
                               ...
                               <?php } ?></td>
                                ...
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['asesor'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['contacto_gen'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['correo_gen'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['contacto_com'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['correo_com'] ?></td> 
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['observaciones'] ?></td>  

                                <td style='white-space: nowrap; width: 1px;'><?php echo"<a href='ver_cliente.php?id_clientes=".$dat['id_clientes']."'><button type='button'class='btn btn-primary colorbtn'><i class='far fa-eye'></i></button></a>"."<a href='modif_cliente.php?id_clientes=".$dat['id_clientes']."'><button type='button' class='btn btn-success1'><i class='fas fa-edit'></i></button></a>"."<a href='php/delete_cliente.php?id_clientes=".$dat['id_clientes']."' class='borrar2'><button type='button' class='btn btn-danger'><i class='fas fa-trash-alt'></i></button></a>"."<a href='actas.php?id_clientes=".$dat['id_clientes']."'><button type='button' class='btn btn-danger acta'><i class='fas fa-file-alt'></i></button></a>";?></td>
                            </tr>
                            <?php 
                                }
                            ?>                                

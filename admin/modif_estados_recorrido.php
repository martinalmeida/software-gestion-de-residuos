      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="update_recorrido" action="" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Editar estado del recorrido: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del estado" class="form-control in-put" value="<?php echo $registro['nombre']; ?>" required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Descripción </label>
                    <textarea class="form-control in-put" name="descripcion" placeholder="Descripción del estado" value="<?php echo $registro['descripcion']; ?>"><?php echo $registro['descripcion']; ?></textarea>
                  </div>
                </div>
                ...
                <div class="form row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <div class="globo">
                      <input type="number" name="orden" placeholder="Orden del estado" class="form-control in-put" value="<?php echo $registro['orden']; ?>" >

      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="register_unidad_nego.php" class="d-none d-sm-inline-block btn btn-sm shadow-sm btnagregar"><i class="fas fa-user-plus text-white"></i> Registrar</a>  
          </div>
          ...
          <div class="table-responsive">        
                        ...
                        <thead class="text-center">
                          <button class="button_excel" type="button" onClick="location.href='excel/excel_unidades.php'" ><i class="far fa-file-excel"></i></button>
                          <a href="pdf/unidades.php" target="_blank"><button class="button_pdf" type="button"><i class="far fa-file-pdf"></i></button></a>   
                            <tr>
                                ...
                                <th style='white-space: nowrap; width: 1px;color: #000'>Sigla</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['sigla'] ?></td>
                                <td style='white-space: nowrap; width: 1px; text-align: center;'><?php echo "<a href='ver_unidad_nego.php?id=".$dat['id']."'><button type='button'class='btn btn-primary colorbtn'><i class='far fa-eye'></i></button></a>"."<a href='modif_unidad_nego.php?id=".$dat['id']."'><button type='button' class='btn btn-success1'><i class='fas fa-edit'></i></button></a>"."<a href='php/delete_unidad_nego.php?id=".$dat['id']."' class='borrar2'><button type='button' class='btn btn-danger'><i class='fas fa-trash-alt'></i></button></a>";?></td>

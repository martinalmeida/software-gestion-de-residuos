...
<body>
	<center>
	  ...
	  <thead style="background-color: #76a03f"> 
	      <tr>                   
            <th class="text-light font-weight-bold" width="660">Nombre</th>
            <th class="text-light font-weight-bold" width="660">Orden</th>     
	      </tr>
	  </thead>
	  <tbody>
	      <?php                            
	      foreach($data as $dat) {                                 
	      ?>
            <td width="660" class="text-dark font-weight-bold"><?php echo $dat['nombre'] ?></td>
            <td width="660" class="text-dark font-weight-bold"><?php echo $dat['orden'] ?></td>
	      </tr>
	      <?php
	          }
	      ?>                                

    ...
    <div class="row">
	  ...
	  <thead style="background-color: #76a03f"> 
	      <tr>
                ...
                <th class="text-light font-weight-bold" width="440">País</th>
                <th class="text-light font-weight-bold" width="440">Ciudad</th>       
	      </tr>
	  </thead>
	  <tbody>
	      <?php                            
	      ...
	      <tr>
                ...
                <td width="440" class="text-dark font-weight-bold"><?php echo $dat['pais'] ?></td>
                <td width="440" class="text-dark font-weight-bold"><?php echo $dat['ciudad'] ?></td>
	      </tr>
	      <?php
	          }
	      ?>                                

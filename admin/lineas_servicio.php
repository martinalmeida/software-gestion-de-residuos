...
$consulta = "SELECT * FROM lineas_servicio WHERE nit=".$_SESSION["empresas_nit"];
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="lineas_servicio.php"><i class="fas fa-file-signature"></i>  Lineas de servicio</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 animated fadeInUp"><b>Lineas de servicio</b></h1>
            <a href="register_lineas_servicio.php" class="d-none d-sm-inline-block btn btn-sm shadow-sm btnagregar"><i class="fas fa-user-plus text-white"></i> Registrar</a>  
          </div>


          <!-- Tabla de Lineas de servicio-->
          <div class="table-responsive">        
                        <table id="tablaPersonas" class="table table-striped table-bordered table-condensed" style="width:100%">
                        <thead class="text-center">
                          <button class="button_excel" type="button" onClick="location.href='excel/excel_lineas.php'" ><i class="far fa-file-excel"></i></button>
                          <a href="pdf/lineas.php" target="_blank"><button class="button_pdf" type="button"><i class="far fa-file-pdf"></i></button></a>
                            <tr>
                                ...
                                <th style='white-space: nowrap; width: 1px;color: #000'>Codigo</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Unidad</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['unidad'] ?></td>
                                <td style='white-space: nowrap; width: 1px; text-align: center;'><?php echo "<a href='ver_lineas_servicio.php?id=".$dat['id']."'><button type='button'class='btn btn-primary colorbtn'><i class='far fa-eye'></i></button></a>"."<a href='modif_lineas_servicio.php?id=".$dat['id']."'><button type='button' class='btn btn-success1'><i class='fas fa-edit'></i></button></a>"."<a href='php/delete_linea_servicio.php?id=".$dat['id']."' class='borrar2'><button type='button' class='btn btn-danger'><i class='fas fa-trash-alt'></i></button></a>";?></td>

      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="insertar_chequeos" action="php/insertar_chequeos.php" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Consultar chequeo: <strong> <?php echo $registro["chequeo"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="chequeo" placeholder="Nombre del chequeo" disabled class="form-control in-put" value="<?php echo $registro['chequeo']; ?>" required>
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Estado <span class="rojo">*</span></label>
                    <select class="custom-select in-put" disabled name="estado" required>
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <select class="custom-select in-put" disabled name="respuesta" required>
                      <option value="<?php echo $registro['respuesta']; ?>"><?php echo $registro['tipo_respuesta']; ?></option>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-4">
                    ...
                    <select class="custom-select in-put" disabled name="obligatoriedad" required>
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <select class="custom-select in-put" disabled name="verificacion" required>
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <select class="custom-select in-put" disabled name="seccion" required>

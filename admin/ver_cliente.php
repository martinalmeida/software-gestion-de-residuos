      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa"  enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Consultar cliente: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del cliente" class="form-control in-put" required value="<?php echo $registro['nombre']; ?>" disabled>
                  </div>
                  ...
                  <div class="col-sm-12 col-md-3">
                    <label class="color">Categoría <span class="rojo">*</span></label>
                    <select class="custom-select in-put" name="categoria" required disabled>
                      <option value="<?php echo $registro['categoria']; ?>"><?php echo $registro['categoria']; ?></option>
                      <option value="Cliente Directo">Cliente Directo</option>
                      <option value="Cliente Gestor">Cliente Gestor</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="telefono" placeholder="Teléfono" class="form-control in-put" required value="<?php echo $registro['telefono']; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="direccion_admin" placeholder="Dirección administrativa" class="form-control in-put" required value="<?php echo $registro['direccion_admin']; ?>" disabled>
                  </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Ref. cotización</label>
                    <input type="text" name="cotizacion" placeholder="Ref. cotización" class="form-control in-put" value="<?php echo $registro['cotizacion']; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class=" col-sm-12 col-md-3">
                    <label class="color">.</label>
                    <input type="time" name="horario_sd1" placeholder="" class="form-control in-put" required value="<?php echo $registro['horario_sd1']; ?>" disabled>
                  </div>
                </div>

                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Asesor comercial <span class="rojo">*</span></label>
                    <select class="custom-select in-put" name="asesor" required disabled>
                      <option value="<?php echo $registro['asesor']; ?>"><?php echo $registro['asesor']; ?></option>
                      <?php 
                      include '../gerente/conexion_bd.php';
                      $consulta="SELECT usuario FROM usuarios WHERE rol = 2";
                ...
                <div class="form-row mt-3">
                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Contacto general <span class="rojo">*</span></label>
                    <input type="text" name="contacto_gen" placeholder="Contacto compras" class="form-control in-put" required value="<?php echo $registro['contacto_gen']; ?>" disabled>
                  </div>

                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Correo contacto general <span class="rojo">*</span></label>
                    <input type="email" name="correo_gen" placeholder="Correo compras" class="form-control in-put" required value="<?php echo $registro['correo_gen']; ?>" disabled>
                  </div>
                </div>

                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Contacto comercial </label>
                    <input type="email" name="contacto_com" placeholder="Contacto comercial" class="form-control in-put" required value="<?php echo $registro['contacto_com']; ?>" disabled>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Correo contacto comercial </label>
                    <input type="email" name="correo_com" placeholder="Correo comercial" class="form-control in-put" required value="<?php echo $registro['correo_com']; ?>" disabled>
                  </div>
                </div>

                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-12">
                    <label class="color">Observaciones generales </label>
                    <textarea class="form-control in-put" name="observaciones" required disabled value="<?php echo $registro['observaciones']; ?>"><?php echo $registro['observaciones']; ?></textarea>
                  </div>
                </div>
                <input type="hidden" name="usuarios_id" value="<?php echo $registro['usuarios_id']; ?>">
                <input type="hidden" name="nit" value="<?php echo $registro['nit']; ?>">
                <input type="hidden" name="id_clientes" value="<?php echo $registro['id_clientes']; ?>">
                  

                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    <button type="button" onClick="location.href='clientes.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>

...
<?php
    ...
    $query="SELECT * FROM metricas WHERE id=".$_GET['id'];
              ...
              <form class="formulario-empresa" id="" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Consultar Metrica: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre de la métrica" class="form-control in-put" value="<?php echo $registro['nombre']; ?>" disabled required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Abreviación <span class="rojo">*</span></label>
                    <input type="text" name="abreviacion" placeholder="Ej: KG" class="form-control in-put" value="<?php echo $registro['abreviacion']; ?>" disabled required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    <button type="button" onClick="location.href='metricas.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>

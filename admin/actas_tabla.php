...
$consulta = "SELECT * FROM actas WHERE nit=".$_SESSION["empresas_nit"];
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 animated fadeInUp"><b>Mis Manifiestos</b></h1>  
          </div>
          ...
          <div class="table-responsive">        
                        ...
                        <thead class="text-center"> 
                            <tr>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Numero</th> 
                                <th style='white-space: nowrap; width: 1px;color: #000'>Fecha</th>                        
                                <th style='white-space: nowrap; width: 1px;color: #000'>Entidad</th>
                                <th style='white-space: nowrap; width: 1px;color: #000'>Equipo</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                              <?php 
                              $originalDate = $dat['fecha'];
                              $newDate = date("d/m/Y", strtotime($originalDate));
                               ?>
                                <td style='white-space: nowrap; width: 1px; text-align: center;'><?php echo $dat['num_manifiesto'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $newDate ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['entidad'] ?></td>
                                <td style='white-space: nowrap; width: 1px;'><?php echo $dat['equipo'] ?></td>
                                <td style='white-space: nowrap; width: 1px; text-align: center;'><?php echo "<a href='acta_modif.php?id=".$dat['id']."'><button type='button' class='btn btn-success1'><i class='fas fa-edit'></i></button></a>"."<a href='acta_generada.php?id=".$dat['id']."' target='_blank'><button type='button' class='btn btn-danger acta'><i class='fas fa-file-alt'></i></button></a>";?></td>
              ...
              Swal.fire({
                ...
                if (result.value) {
                  $.ajax({
                          ...
                          type: "POST",
                          success: function(){
                              window.location.href = "actas_tabla.php";
                              Swal.fire({
                              type: 'success',

      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="unidad_nego" action="php/insertar_unidad_nego.php" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Formulario de registro de unidad de negocio</b></h5>
                ...
                <div class="form-row mt-3">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <div class="globo2">
                      <input type="text" maxlength="3" name="sigla" placeholder="Solo 3 letras" class="form-control in-put">

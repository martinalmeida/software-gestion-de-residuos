      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="update_residuos" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del residuo" class="form-control in-put" value="<?php echo $registro['nombre']; ?>">
                  </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class=" col-sm-12 col-md-6">
                    ...
                    <select multiple class="form-control in-put" name="disposicion[]" id="exampleFormControlSelect2" required> 

                    <option selected="selected" value="<?php echo $registro['disposicion']?> "><?php echo $registro['disposicion']?></option> 
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="number" name="codigo" placeholder="Codigo interno" class="form-control in-put" value="<?php echo $registro['codigo']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-4">
                    ...
                    <div class="globo">
                      <input type="text" name="valor" placeholder="" class="form-control in-put" value="<?php echo $registro['valor']; ?>" required>
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <select class="custom-select in-put" name="metrica">
                    ...
                    <div class="formulario">
                      <?php if ($registro['facturacion'] == "Compra"){ ?>
                          <div class="form-check form-check-inline mt-1">
                            <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios2" value="Cobro">
                            <label class="form-check-label" for="gridRadios2">Cobro</label>
                          </div> 
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" checked type="radio" name="gridRadios" id="gridRadios1" value="Compra">
                            <label class="form-check-label" for="gridRadios1">Compra</label>
                          </div> 
                      <?php }else{ ?>
                          <div class="form-check form-check-inline mt-1">
                            <input class="form-check-input" checked type="radio" name="gridRadios" id="gridRadios2" value="Cobro">
                            <label class="form-check-label" for="gridRadios2">Cobro</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="Compra">
                            <label class="form-check-label" for="gridRadios1">Compra</label>
                          </div>  
                      <?php } ?> 
                ...
                <input type="hidden" name="id_residuos" value="<?php echo $registro['id_residuos']; ?>">

              ...
              <form class="formulario-empresa" id="registro_sucursal" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Formulario de Registro de sucursales</b></h5>
                ...
                <div class="form-row mt-4">
                 ...
                 <div class="col-sm-12 col-md-3">
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="contacto" placeholder="Nombre del contacto" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="number" name="telefono" placeholder="Telefono de la sucursal" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Celular <span class="rojo">*</span></label>
                    <input type="number" name="celular" placeholder="" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="email" name="correo" placeholder="Correo del contacto" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Dirección <span class="rojo">*</span></label>
                    <input type="text" name="direccion" placeholder="Dirección de la sucursal" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class=" col-sm-12 col-md-6">
                    ...
                    <input type="text" name="latitud" id="latitud" placeholder="Contacto compras" class="form-control in-put" required>
                  </div>

                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Longitud <span class="rojo">*</span></label>
                    <input type="text" id="longitud" name="longitud" placeholder="Correo compras" class="form-control in-put" required>
                  </div>
                </div>

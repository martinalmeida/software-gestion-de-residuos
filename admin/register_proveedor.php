  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="register_proveedor" action="" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Formulario de Registro de Proveedores</b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del proveedor / destino" class="form-control in-put" required>
                  </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="number" name="identificacion" placeholder="Identificación del cliente" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Digito de verificación </label>
                    <input type="number" name="digito" placeholder="" class="form-control in-put">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="representante" placeholder="Representante legal" class="form-control in-put">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Teléfono <span class="rojo">*</span></label>
                    <input type="number" name="telefono" placeholder="Teléfono" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="direccion_admon" placeholder="Dirección administrativa" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Dirección correspondencia<span class="rojo">*</span></label>
                    <input type="text" name="direccion_corres" placeholder="Dirección correspondencia" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class=" col-sm-12 col-md-6">
                    ...
                    <input type="text" name="acti_eco" placeholder="Actividad económica" class="form-control in-put">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Sitio Web </label>
                    <input type="text" name="sitio_web" placeholder="Sitio Web" class="form-control in-put">
                  </div>
                </div>

                <div class="form-row mt-4">
                  <div class=" col-sm-12 col-md-6">
                    <label for="exampleFormControlSelect2" class="color">Tipo de proveedor / destino <span class="rojo">*</span></label>
                  ...
                  <div class=" col-sm-12 col-md-6">
                    <label for="exampleFormControlSelect2" class="color">Disposiciones y manejos</label>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-5">
                      <label class="color">Cargar Licencia ambiental (PDF) Maximo 3MB </label>
                       <div class="custom-file">                                   
                        <input onchange="ValidateSize(this)" type="file" id="fuSubirExcel" name="licencia" class="custom-file-input" accept=".pdf" />                    
                ...
                <div class="form-row mt-4">
                  <div class=" col-sm-12 col-md-3">
                    ...
                    <input type="time" name="horario_lv" placeholder="" class="form-control in-put" required>
                  </div>
                  <div class=" col-sm-12 col-md-3">
                    <label class="color">.</label>
                    <input type="time" name="horario_lv1" placeholder="" class="form-control in-put" required>
                  </div>

                  <div class=" col-sm-12 col-md-3">
                    <label class="color">Horario Sabados y domingos </label>
                    <input type="time" name="horario_sd" placeholder="" class="form-control in-put">
                  </div>

                  <div class=" col-sm-12 col-md-3">
                    <label class="color">.</label>
                    <input type="time" name="horario_sd1" placeholder="" class="form-control in-put">
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class=" col-sm-12 col-md-6">
                    ...
                    <input type="text" name="contacto_compras" placeholder="Contacto compras" class="form-control in-put">
                  </div>

                  <div class=" col-sm-12 col-md-6">
                    <label class="color">Correo contacto de Compras </label>
                    <input type="email" name="correo_compras" placeholder="Correo compras" class="form-control in-put">
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="contacto_comer" placeholder="Contacto comercial" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Correo contacto comercial <span class="rojo">*</span></label>
                    <input type="email" name="correo_comer" placeholder="Correo comercial" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    <button type="submit" id="upload" class="botonreg">Guardar</button>
                  </div>
                </div>
      ...
      <?php require_once "vistas/vista_inferior.php"?>
        ...
        <!-- Seleccion de un archivo pdf del input file -->
        ...
        <!-- Tamaño de la imagen que se permite insertar en la base de datos -->
        ...
        if (FileSize > 3) {
          input=document.getElementById("fuSubirExcel");
          input.value = '' 
            Swal.fire({
              type:'error',
         ...
         <!-- Ventana al entrar al fomulario de registro del proveedor -->

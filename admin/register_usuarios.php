      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" action="" id="register-usuarios" method="POST" enctype="multipart/form-data">

                 <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Formulario de Registro de Usuarios</b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-5">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre y apellidos" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Identificación <span class="rojo">*</span></label>
                    <input type="number" name="identificacion" placeholder="Cedula" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Cargo </label>
                    <input type="text" name="cargo" placeholder="Cargo del usuario" class="form-control in-put">
                  </div>
                </div>

                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Módulo de acceso / Rol <span class="rojo">*</span></label>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="telefono" placeholder="Teléfono" class="form-control in-put">
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Celular </label>
                    <input type="text" name="celular" placeholder="Celular" class="form-control in-put">
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Correo <span class="rojo">*</span></label>
                    <input type="email" name="correo" placeholder="Correo" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="direccion" placeholder="Dirección" class="form-control in-put">
                  </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="usuario" placeholder="Nombre de usuario" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Clave <span class="rojo">*</span></label>
                    <input type="text" name="contrasena" id="password" placeholder="Clave de Acceso" class="form-control in-put" required>
                  </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="licencia" placeholder="Número de Licencia de tránsito" class="form-control in-put">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Fecha vencimiento de licencia de tránsito </label>
                    <input type="date" name="fechlicencia" placeholder="" class="form-control in-put">
                  </div>
                </div>

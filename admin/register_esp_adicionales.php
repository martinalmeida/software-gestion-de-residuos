              ...
              <form class="formulario-empresa" id="register_esp_adicionales" action="php/insertar_esp_adicionales.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Formulario de registro de especificaciones adicionales</b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del servicio adicional" class="form-control in-put" required>
                  </div>

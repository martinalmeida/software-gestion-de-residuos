      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="update_esp_adicionales" action="" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Editar Especificaciones adicionales: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del servicio adicional" class="form-control in-put" required value="<?php echo $registro['nombre']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Descripción del servicio </label>
                    <textarea class="form-control in-put" value="<?php echo $registro['descripcion']; ?>" name="descripcion"><?php echo $registro['descripcion']; ?></textarea>
                  </div>
                </div>

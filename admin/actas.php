    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
                ...
                <?php  
                $query1="SELECT * FROM actas WHERE nit = ".$_SESSION['empresas_nit'];
                $resultado1=mysqli_query($mysqli,$query1);
                $registro1=mysqli_fetch_array($resultado1); 

                    if (isset($registro1["num_manifiesto"]) == null) { ?>
                    
                    <div class="form-row">
                        <div class=" col-sm-12 col-md-12">
                            <h5 style="color: #217b1c; text-align: center;"><b>Ingresar numero de manifiesto</b></h5>
                      ...
                      <div class='card shadow mb-4'>
                        <div class='card-body'>
                          <form action='acta_configurar.php' method='POST' enctype='multipart/form-data'>
                            <div class='form-row'>
                              <div class='col-sm-12 col-md-12'>
                                <p style="color: black"><b style="color: red">Nota:</b> <b>Antes de realizar el primer registro, por favor asigne el numero de manifiesto por el cual desea comenzar.</b></p>
                                <label class='color'>Numero Actual de Manifiestos <span class='rojo'>*</span></label>
                                <input type='number' name='numero' placeholder='Numero actual' class='form-control in-put' required>
                              </div>
                            </div>  
                            <br>
                            <div class='form-row'>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c; text-align: center;"><b>Manifiesto para el cliente <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                    <hr style="border-color: #76a03f">
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="col-sm-12 col-md-12">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active acta1" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Manifiestos</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link acta1" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Planillas</a>
                      </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                      <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">

                        <form action="acta_enviar_email.php" method="POST" enctype="multipart/form-data">
                          ...
                          <!--Sección 1 Collapse-->
                            ...
                            <div id="accordion">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <div class="form-row mt-2">
                                      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        ...
                                        <input type="text" name="ciudad" value="Barrancabermeja" class="form-control in-put" required>
                                      </div>
                                      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        <label class="color">Fecha: <span class="rojo">*</span></label>
                                        <input type="date" name="fecha" placeholder="" class="form-control in-put" required>
                                      </div>
                                      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        <label class="color">ID: </label>
                                        <input type="text" name="id_manifiesto" placeholder="" class="form-control in-put">
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-row mt-2">
                                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <input type="text" name="entidad" value="<?php echo $registro["nombre"];?>" class="form-control in-put" required>
                                      </div>
                                      <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                        <label class="color">Equipo: </label>
                                        <input type="text" name="equipo" class="form-control in-put">
                                      </div>
                                      <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                        <label class="color">Placa vehiculo: <span class="rojo">*</span></label>
                                        <input type="text" name="placa" class="form-control in-put" required>
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-row mt-2">
                                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <input type="text" name="conductor" class="form-control in-put" required>
                                      </div>
                                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        <label class="color">Hora recolección: <span class="rojo">*</span></label>
                                        <input type="time" name="hora_re" class="form-control in-put" required>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div id="collapse4" class="panel-collapse collapse in show">
                                  <div class="card-body">
                                    <div class="form-group">
                                       ...
                                       <textarea class="form-control in-put" name="observaciones" placeholder=""></textarea>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <!--Sección 5 Collapse-->
                                ...
                                <?php 
                                $query="SELECT MAX(num_manifiesto) AS num_manifiesto FROM actas WHERE nit=".$_SESSION["empresas_nit"];
                                $resultado=mysqli_query($mysqli,$query);
                                $consulta=mysqli_fetch_array($resultado);
                                $numero = $consulta['num_manifiesto'];
                                $suma = ($numero+1);
                                ?>
                                <input type="hidden" name="nit" value="<?php echo $_SESSION["empresas_nit"];  ?>">
                                <input type="hidden" name="num" value="<?php echo $suma;  ?>">
                                <input type="hidden" name="id_cliente" value="<?php echo $_GET['id_clientes']; ?>">
                            ...
                            <div class="form-row mt-4">
                              <div class="col-sm-12 col-md-12 text-center">
                                <!-- Boton para envio -->
                                <button type="submit" class="botonenviar">Guardar y Enviar</button>
                              </div>
                            </div>
                            
                        </form>
                      </div>
                      <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">Manifiesto de planillas</div>
                    </div>
                  </div>
                </div>
        ...
        <?php require_once "vistas/vista_inferior.php"?>
          ...
          <script type="text/javascript">
            $(document).ready(function() {
                ...
                { 
                    var imgVal = $('#draw-dataUrl').val(); 
                    if(imgVal=='') 
                    { 
                        Swal.fire({
                        type:'error',
                        title: 'Oh no !!',
                        text: 'Es obligatoria la firma del Despachador',
          ...
          <script type="text/javascript">
            $(document).ready(function() {
                $('#upload').bind("click",function() 
                { 
                    var imgVal = $('#draw2-dataUrl').val(); 
                    if(imgVal=='') 
                    { 
                        Swal.fire({
                        type:'error',
                        title: 'Oh no !!',
                        text: 'Es obligatoria la firma del Recibido',
                        confirmButtonColor:'#76a03f'
                      }) 
                        return false; 
                    } 

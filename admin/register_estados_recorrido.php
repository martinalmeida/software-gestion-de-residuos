              ...
              <form class="formulario-empresa" id="insertar_estados_recorrido" action="php/insertar_estados_recorrido.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Formulario de estados de recorrido</b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del estado" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Descripción </label>
                    <textarea class="form-control in-put" name="descripcion" placeholder="Descripción del estado"></textarea>
                  </div>
                </div>
                ...
                <div class="form row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <div class="globo">
                      <input type="number" name="orden" placeholder="Orden del estado" class="form-control in-put">

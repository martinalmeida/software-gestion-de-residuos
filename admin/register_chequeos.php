              ...
              <form class="formulario-empresa" id="insertar_chequeos" action="php/insertar_chequeos.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Formulario de registro de chequeos</b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="chequeo" placeholder="Nombre del chequeo" class="form-control in-put" required>
                  </div>

      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="insertar_riesgos" action="php/insertar_riesgos.php" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Formulario de Registro de Riesgos</b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre del riesgo" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Descripción <span class="rojo">*</span></label>
                    <textarea class="form-control in-put" name="descripcion" placeholder="Efectos negativos que produce" required=""></textarea>
                  </div>
                </div>

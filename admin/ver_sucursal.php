      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="registro_sucursal" action="" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Consultar Sucursal: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <select class="custom-select in-put" name="tipo" disabled required>
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <select class="custom-select in-put" name="origen" disabled required>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-5">
                    ...
                    <input type="text" name="nombre" placeholder="" class="form-control in-put" value="<?php echo $registro['nombre']; ?>" disabled required>
                  </div>

                 <div class="col-sm-12 col-md-3">
                    <label class="color">Clasificación </label>
                    <select class="custom-select in-put" name="clasificacion" disabled>
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="contacto" placeholder="Nombre del contacto" value="<?php echo $registro['contacto']; ?>" class="form-control in-put" disabled required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="number" name="telefono" placeholder="Telefono de la sucursal" class="form-control in-put" value="<?php echo $registro['telefono']; ?>" disabled required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Celular <span class="rojo">*</span></label>
                    <input type="number" name="celular" placeholder="" value="<?php echo $registro['celular']; ?>" class="form-control in-put" disabled required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="email" name="correo" placeholder="Correo del contacto" class="form-control in-put" value="<?php echo $registro['correo']; ?>" disabled required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Dirección <span class="rojo">*</span></label>
                    <input type="text" name="direccion" placeholder="Dirección de la sucursal" class="form-control in-put" value="<?php echo $registro['direccion']; ?>" disabled required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-3">
                    ...
                    <select class="custom-select in-put" name="pais" disabled required>
                  ...
                  <div class="col-sm-12 col-md-5">
                    ...
                    <select class="custom-select in-put" name="ciudad" disabled required>
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <select class="custom-select in-put" name="zona" disabled>
                ...
                <div class="form-row mt-4">
                  <div class=" col-sm-12 col-md-3">
                    ...
                    <input type="time" name="horario_lv" placeholder="" class="form-control in-put" value="<?php echo $registro['horario_lv']; ?>" disabled required>
                  </div>
                  <div class=" col-sm-12 col-md-3">
                    <label class="color">.</label>
                    <input type="time" name="horario_lv1" placeholder="" class="form-control in-put" value="<?php echo $registro['horario_lv1']; ?>" disabled required>
                  </div>
                ...
                <div class="form-row mt-3">
                  <div class=" col-sm-12 col-md-6">
                   <!-- <label class="color">Latitud <span class="rojo">*</span></label> -->
                    <input type="hidden" name="latitud" id="latitud" placeholder="Contacto compras" class="form-control in-put" value="<?php echo $registro['latitud']; ?>" disabled required>
                  </div>

                  <div class=" col-sm-12 col-md-6">
                   <!-- <label class="color">Longitud <span class="rojo">*</span></label> -->
                    <input type="hidden" id="longitud" name="longitud" placeholder="Correo compras" class="form-control in-put" value="<?php echo $registro['longitud']; ?>" disabled required>
                  </div>
                </div>

              ...
              <form class="formulario-empresa" id="register_vehiculos" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Formulario de Registro de Vehículos</b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="marca" placeholder="Nombre de la marca" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Capacidad <span class="rojo">*</span></label>
                    <input type="text" name="capacidad" placeholder="Capacidad de carga" class="form-control in-put" required>
                  </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="placa" placeholder="Placa del vehículo" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Modelo </label>
                    <input type="text" name="modelo" placeholder="Indique el año Ej: 2017" class="form-control in-put">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="color" placeholder="Indique el color" class="form-control in-put">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Tipo de vehículo <span class="rojo">*</span></label>
                    <input type="text" name="tipo" placeholder="Ej: Camión tipo furgon" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="propietario" placeholder="Nombre del propietario" class="form-control in-put">
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Identificación del propietario </label>
                    <input type="text" name="identificacion_pro" placeholder="" class="form-control in-put">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="tecnomecanica" placeholder="Número Tecnomecanica" class="form-control in-put">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Fecha vencimiento Tecnomecanica </label>
                    <input type="date" name="fecha_venc" placeholder="" class="form-control in-put">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="soat" placeholder="Número SOAT" class="form-control in-put">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Fecha vencimiento SOAT </label>
                    <input type="date" name="venc_soat" placeholder="" class="form-control in-put">
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class=" col-sm-12 col-md-6">
                    ...
                    <input type="date" name="venc_sanitario" placeholder="" class="form-control in-put">
                  </div>
                </div>

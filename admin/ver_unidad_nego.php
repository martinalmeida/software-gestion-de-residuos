...
<?php
    ...
    $query="SELECT * FROM ud_negocio WHERE id=".$_GET['id'];
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Tablas:</h6>
            <a class="collapse-item active" href="unidades_negocio.php"><i class="far fa-handshake"></i>  Unidades de negocio</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="unidad_nego" action="insertar_unidad_nego.php" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Consultar Unidad de negocio: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <textarea class="form-control in-put" name="descripcion" value="<?php echo $registro['descripcion']; ?>" disabled ><?php echo $registro['descripcion']; ?></textarea>
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <div class="globo">
                      <input type="number" name="codigo" placeholder="" class="form-control in-put" value="<?php echo $registro['codigo']; ?>" disabled required>
                      <span>Codigo interno o contable</span>
                    </div>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Sigla </label>
                    <div class="globo2">
                      <input type="text" maxlength="3" name="sigla" placeholder="Solo 3 letras" class="form-control in-put" value="<?php echo $registro['sigla']; ?>" disabled>
                      <span>SIGLA para integración con facturación electrónica</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    <button type="button" onClick="location.href='unidades_negocio.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>

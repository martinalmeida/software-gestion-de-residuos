...
<?php
    ...
    $query="SELECT * FROM lineas_servicio WHERE id=".$_GET['id'];
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" id="lineas_servicio" action="php/insertar_lineas_servicio.php" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class=" col-sm-12 col-md-12">
                    <h5 style="color: #217b1c"><b>Consultar Linea de servicio: <strong> <?php echo $registro["nombre"];?> </strong></b></h5>
                ...
                <div class="form-row mt-2">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="nombre" placeholder="" class="form-control in-put" value="<?php echo $registro['nombre']; ?>" required disabled>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Descripción </label>
                    <textarea class="form-control in-put" disabled name="descripcion" value="<?php echo $registro['descripcion']; ?>" ><?php echo $registro['descripcion']; ?></textarea>
                  </div>
                </div>

                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Codigo <span class="rojo">*</span></label>
                    <div class="globo">
                      <input type="number" name="codigo" disabled placeholder="" class="form-control in-put" value="<?php echo $registro['codigo']; ?>" required>
                      <span>Codigo interno o contable</span>
                    </div>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Unidad de negocio <span class="rojo">*</span></label>
                    <select class="custom-select in-put" disabled name="unidad"  required>
                      <option value="<?php echo $registro['unidad']; ?>"><?php echo $registro['unidad']; ?></option>
                      <?php 
                      include '../gerente/conexion_bd.php';
                      $consulta="SELECT nombre FROM ud_negocio";
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    <button type="button" onClick="location.href='lineas_servicio.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>

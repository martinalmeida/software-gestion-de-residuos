  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!---------------------------------------------------------------------------------------- 
              Inicio del contenido de la Página de REGISTRO DE USUARIOS y CONTAINER-FLUID 
        ------------------------------------------------------------------------------------------>

        <div class="container-fluid">

          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center animated fadeInUp"><b>Formulario de Registro de Usuarios</b></h1>

          <div class="card shadow mb-4">
            <div class="card-body">

              <form class="formulario-usuarios" id="uploadImageForm" action="insertar_bd2.php" method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="email" name="correo" placeholder="Correo Electrónico" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Contraseña <span class="rojo">*</span></label>
                    <div class="input-group">
                      <input type="password" id="passs" name="clave" class="form-control in-put" placeholder="Contraseña" required>
                ...
                <div class="form-row mt-3">
                  ...
                  <div class="col-sm-12 col-md-5">
                    ...
                    <input type="text" name="nombre" placeholder="Nombre y Apellido" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Identificación <span class="rojo">*</span></label>
                    <input type="number" name="identificacion" placeholder="Identificación" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="cargo" placeholder="Cargo del usuario" class="form-control in-put" required>
                  </div>
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="number" name="celular" placeholder="Celular" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="licencia" placeholder="Licencia" class="form-control in-put">
                  </div>
                  
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Fecha de Vencimiento de licencia de tránsito</label>
                    <input type="date" name="vencimiento" placeholder="Fecha de Vencimiento de licencia de tránsito" class="form-control in-put">
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-4">
                    ...
                    <select class="custom-select in-put" name="nit" required>
                      <option value="">Seleccione una opción</option>
                      <?php 
                      include 'conexion_bd.php';
        ...
        <!---------------------------------------------------------------------------------------- 
              FIN del contenido de la Página de REGISTRO DE USUARIOS y CONTAINER-FLUID 
        ------------------------------------------------------------------------------------------>

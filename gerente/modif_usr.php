  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!---------------------------------------------------------------------------------------- 
              Inicio del contenido de la Página de Modificación usuario y CONTAINER-FLUID 
        ------------------------------------------------------------------------------------------>

        <div class="container-fluid">

          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center">Editar usuario <strong style="color: #16a086;"> <?php echo $registro["usuario"];?> </strong></h1>

          <div class="card shadow mb-4">
            <div class="card-body">

              <form class="formulario-editar-usuarios" action="update_usr.php" method="POST" enctype="multipart/form-data" role="form" >
                <div class="form-row">
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="email" name="correo" placeholder="Correo Electrónico" class="form-control in-put" required value="<?php echo $registro['correo']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Contraseña <span class="rojo">*</span></label>
                    <div class="input-group">
                      <input  id="passs" name="clave" class="form-control in-put" placeholder="Contraseña">
                       <div class="input-group-append">
                       <button class="btn btn-md btn-outline-default1 m-0 px-3 py-2 z-depth-0 waves-effect" type="button" id="showw">
                ...
                <div class="form-row mt-3">
                  ...
                  <div class="col-sm-12 col-md-5">
                    <label class="color">Nombre y Apellido <span class="rojo">*</span></label>
                    <input type="text" name="nombre" placeholder="Nombre y Apellido" class="form-control in-put" required value="<?php echo $registro['nombre']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-4">
                    <label class="color">Identificación <span class="rojo">*</span></label>
                    <input type="number" name="identificacion" placeholder="Identificación" class="form-control in-put" value="<?php echo $registro['identificacion']; ?>">
                  </div>
                </div>

                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-4">
                    <label class="color">Cargo <span class="rojo">*</span></label>
                    <input type="text" name="cargo" placeholder="Cargo del usuario" class="form-control in-put" required value="<?php echo $registro['cargo']; ?>">
                  </div>
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="number" name="celular" placeholder="Celular" class="form-control in-put" required value="<?php echo $registro['celular']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="licencia" placeholder="Licencia" class="form-control in-put" value="<?php echo $registro['licencia']; ?>" >
                  </div>
                  
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Fecha de Vencimiento de licencia de tránsito</label>
                    <input type="date" name="fecha_venc" placeholder="Fecha de Vencimiento de licencia de tránsito" class="form-control in-put" value="<?php echo $registro['fecha_venc']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-4">
                    <label class="color">NIT Empresa <span class="rojo">*</span></label>
                    <select class="custom-select in-put" name="empresas_nit" required>
                      <option value="<?php echo $registro['empresas_nit']; ?>"><?php echo $registro['empresas_nit']; ?></option>
                      <?php 
                      include 'conexion_bd.php';
                      ...
                      <?php foreach ($ejecutar as $opciones):?>
                        ...
                        <option value="<?php echo $opciones['nit']?> "><?php echo $opciones['nit']?></option>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    <button id="upload" type="submit" class="botonreg">Guardar</button>
                    <button type="button" onClick="location.href='usuarios_gerente.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>
              </form>
            </div>
        ...
        <!---------------------------------------------------------------------------------------- 
                  FIN del contenido de la Página de Modificación USUARIO y CONTAINER-FLUID 
        ------------------------------------------------------------------------------------------>

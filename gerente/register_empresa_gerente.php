    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center animated fadeInUp"><b>Formulario de Registro de Empresas</b></h1>

          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-empresa" action="insertar_bd.php" method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  <div class="col-sm-12 col-md-4">
                    <label class="color">NIT <span class="rojo">*</span></label>
                    <input type="number" name="nit" placeholder="NIT de la empresa" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-3">
                    <label class="color">Digito de verificación <span class="rojo">*</span></label>
                    <input type="number" name="digito" placeholder="NIT de la empresa" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-5">
                    <label class="color">Razón social / Nombre <span class="rojo">*</span></label>
                    <input type="text" name="nombre" placeholder="Nombre de la empresa" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="representante" placeholder="Representante Legal" class="form-control in-put" required>
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Telefono <span class="rojo">*</span></label>
                    <input type="number" name="telefono" placeholder="Telefono" class="form-control in-put" required>
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="direccion" placeholder="Dirección Administrativa" class="form-control in-put" required>
                  </div>
                ...
                <div class="form-row mt-3">
                  ...
                  <div class="col-sm-12 col-md-4">
                    ...
                    <input type="text" name="sitioweb" placeholder="Sitio Web" class="form-control in-put" required>
                  </div>
                </div>

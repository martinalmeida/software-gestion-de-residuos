...
<?php
    ...
    $query="SELECT * FROM empresas WHERE nit=".$_GET['nit'];
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!---------------------------------------------------------------------------------------- 
          Inicio del contenido de la Página de Modificación y CONTAINER-FLUID 
        ------------------------------------------------------------------------------------------>

        <div class="container-fluid">

          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center">Editar a <strong style="color: #16a086;"> <?php echo $registro["nombre"];?> </strong></h1>

          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="formulario-editar-empresas" action="update_emp.php" method="POST" enctype="multipart/form-data">
                <div class="form-row">

                    <input  type="hidden" name="nit"  placeholder="NIT de la empresa" class="form-control in-put" required value="<?php echo $registro['nit']; ?>">
      
                    <input type="hidden"  name="digito" placeholder="NIT de la empresa" class="form-control in-put" required value="<?php echo $registro['digito']; ?>">
               
                  <div class="col-sm-12 col-md-12">
                    <label class="color">Razón social / Nombre <span class="rojo">*</span></label>
                    <input type="text" name="nombre" placeholder="Nombre de la empresa" class="form-control in-put" required value="<?php echo $registro['nombre']; ?>">
                  </div>
                </div>

                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    <label class="color">Representante Legal <span class="rojo">*</span></label>
                    <input type="text" name="representante" placeholder="Representante Legal" class="form-control in-put" required value="<?php echo $registro['representante']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Telefono <span class="rojo">*</span></label>
                    <input type="number" name="telefono" placeholder="Telefono" class="form-control in-put" required value="<?php echo $registro['telefono']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-3">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <input type="text" name="direccion" placeholder="Dirección Administrativa" class="form-control in-put" required value="<?php echo $registro['direccion']; ?>">
                  </div>

                  <div class="col-sm-12 col-md-6">
                    <label class="color">Correo Electrónico <span class="rojo">*</span></label>
                ...
                <div class="form-row mt-3">
                  ...
                  <div class="col-sm-12 col-md-4">
                    <label class="color">Sitio Web <span class="rojo">*</span></label>
                    <input type="text" name="sitio_web" placeholder="Sitio Web" class="form-control in-put" required value="<?php echo $registro['sitio_web']; ?>">
                  </div>
                </div>
                ...
                <div class="form-row mt-4">
                  <div class="col-sm-12 col-md-12 text-center">
                    ...
                    <button type="button" onClick="location.href='empresas_gerente.php'" class="botoncan">Cancelar</button>
                  </div>
                </div>
        ...
        <!---------------------------------------------------------------------------------------- 
                    FIN del contenido de la Página de Modificación y CONTAINER-FLUID 
        ------------------------------------------------------------------------------------------>
